...
const BOWLS = {
  inhale: {
    ...
    groups: [
      { freqs: [86.3, 87.0],     gains: [0.65, 0.50], decay: 5.5 },
      { freqs: [258.4, 259.4],   gains: [0.45, 0.45], decay: 4.5 },
      { freqs: [502.7, 505.7, 516.8], gains: [0.20, 0.18, 0.60], decay: 3.5 },
      { freqs: [809.3, 812.5, 815.7], gains: [0.05, 0.70, 0.05], decay: 2.5 },
    ],
  },
  exhale: {
    masterGain: 0.30,
    groups: [
      { freqs: [129.5, 130.5],     gains: [0.65, 0.50], decay: 5.5 },
      { freqs: [387.6, 389.1],     gains: [0.45, 0.45], decay: 4.5 },
      { freqs: [754.1, 758.5, 775.2], gains: [0.20, 0.18, 0.60], decay: 3.5 },
      { freqs: [1214, 1218.8, 1223.6], gains: [0.05, 0.70, 0.05], decay: 2.5 },
    ],
  },
}
...
export function strikeSingingBowl(type = 'inhale') {
  ...
  masterGain.gain.exponentialRampToValueAtTime(1e-5, now + 7.0)
